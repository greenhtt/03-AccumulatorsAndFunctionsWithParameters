...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher, Mark Hays,
         Aaron Wilkin, their colleagues, and Tierney Greenhoe.
...
def draw_circles1():
    ...
    centerpt = rg.Point(200,200)
    for k in range(21):
        print(k*10)
        circle = rg.Circle(centerpt,k*10)
...
def draw_circles2():
    ...
    for k in range(18):
        centerpt = (k*20)+50
        radius = 10
        circle = rg.Circle(rg.Point(centerpt,100),radius)
...
def draw_circles3():
    ...
    for k in range(100):
        radius = k+1
        centerpt = rg.Point(200,150)
        circle = rg.Circle(centerpt,radius)
        circle.attach_to(window)
    window.render()
    window.close_on_mouse_click()
...
def draw_cosines_and_sines():
    ...
    radius = 10
    for k in range(101):
        rg.Circle(rg.Point((200+(80*math.cos(k))),(200+(80*math.sin(k)))),radius).attach_to(window)
    window.render()
    window.close_on_mouse_click()
